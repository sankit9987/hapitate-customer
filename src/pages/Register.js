...
function Register() {
    return (
        ...
        <div className='col-lg-11 shadow-lg'>
            <nav className="comment-log-reg-tabmenu core-nav py-3">
                    <div className="full-container">
                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                            <Link id="nav-log-tab" className="nav-item nav-link login active" data-toggle="tab" to="/login" role="tab" aria-controls="nav-log" aria-selected="true">
                                Vendor Login
                            </Link>
                            <Link className="nav-item nav-link" id="nav-reg-tab" data-toggle="tab"
                                to="/register" role="tab" aria-controls="nav-reg" aria-selected="false">
                                Vendor Register
                            </Link>
                        </div>
                    </div>
            ...
            <div id="wcfm-main-contentainer">
                <div id="wcfm-content">
                    <div class="wcfm-membership-wrapper">
                        <h2 class="wcfm_registration_form_heading">Registration</h2>
                                ...
                                <div class="wcfm-container">
                                    <div id="wcfm_membership_registration_form_expander" class="wcfm-content">
                                        ...
                                        <label class="screen-reader-text" for="user_name">Username<span
                                                class="required">*</span></label><input type="text" id="user_name" style={{width: "63%"}}

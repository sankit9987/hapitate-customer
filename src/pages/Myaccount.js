                                        ...
                                        <div className="u-columns col2-set" id="customer_login">
                                            <div className="u-column1 col-1">
                                                ...
                                                <form className="woocommerce-form woocommerce-form-login login" method="post">
                                                    ...
                                                    <p className="woocommerce-form-row woocommerce-form-row--wide form-row-wide">
                                                    ...
                                                    <p >
                                                        <label
                                                            ...
                                                            <input className="woocommerce-form__input woocommerce-form__input-checkbox mx-1"
                                                                name="rememberme" type="checkbox" id="rememberme" value="forever"/>
                                                                <span>Remember me</span>
                                                        </label><br/>
                                                        <input type="hidden" id="woocommerce-login-nonce"
                                                            name="woocommerce-login-nonce" value="67787194c7"/><input type="hidden"
                                                                name="_wp_http_referer" value="/hapitate/my-account/"/> <button
                                                                    type="submit"
                                                    ...
                                                    <div className="u-column2 col-2">
                                                        ...
                                                        <form method="post" className="woocommerce-form woocommerce-form-register register">
                                                            ...
                                                            <p className="form-row form-row-wide mailchimp-newsletter"><input type="checkbox"
                                                                className="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox"
                                                                id="mailchimp_woocommerce_newsletter"
                                                                name="mailchimp_woocommerce_newsletter" value="1" checked=""/> <label
                                                            ...
                                                            <div className="woocommerce-privacy-policy-text">
                                                                <p>Your personal data will be used to support your experience throughout
                                                                    ...
                                                                    described in our <a href="./../privacy-policy/index.html"
                                                            ...
                                                            <p className="woocommerce-form-row form-row">
                                                                <input type="hidden" id="woocommerce-register-nonce"
                                                                    name="woocommerce-register-nonce" value="26cbcbd603"/><input
                                                                        type="hidden" name="_wp_http_referer" value="/hapitate/my-account/"/>
                                                                        <button type="submit"
                                                                    ...
                                                                    <div className="register-benefits">
                                                                        ...
                                                                        <ul>
                                                                        <li>✔️Speed your way through checkout</li>
                                                                            <li>✔️Track your orders easily</li>
                                                                            <li>✔️Keep a record of all your purchases</li>
                                                                        </ul>
                                                                    </div>
                                                                </form>
                                                            </div>
